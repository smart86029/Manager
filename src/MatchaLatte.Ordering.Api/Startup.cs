...
namespace MatchaLatte.Ordering.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<OrderingContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Ordering")));
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterModule(new ServicesModule(Configuration.GetConnectionString("Ordering")));
        }
