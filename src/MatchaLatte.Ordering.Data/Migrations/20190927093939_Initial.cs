        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderItemProductAccessoryId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DomainEvent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DomainEvent_Buyer_BuyerId",
                        column: x => x.BuyerId,
                        principalSchema: "Ordering",
                    ...
                    table.ForeignKey(
                        name: "FK_DomainEvent_Order_OrderId",
                        column: x => x.OrderId,
                        principalSchema: "Ordering",
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DomainEvent_OrderItem_OrderItemId",
                        column: x => x.OrderItemId,
                        principalSchema: "Ordering",
                        principalTable: "OrderItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DomainEvent_OrderItemProductAccessory_OrderItemProductAccessoryId",
                        column: x => x.OrderItemProductAccessoryId,
                        principalSchema: "Ordering",
                        principalTable: "OrderItemProductAccessory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_DomainEvent_BuyerId",
                schema: "Ordering",
                table: "DomainEvent",
                column: "BuyerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DomainEvent_OrderItemId",
                schema: "Ordering",
                table: "DomainEvent",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_DomainEvent_OrderItemProductAccessoryId",
                schema: "Ordering",
                table: "DomainEvent",
                column: "OrderItemProductAccessoryId");
